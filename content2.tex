...
\begin{figure}
\centering
\includegraphics[scale=.20]{FUNsArchitecture.png}
...
\begin{figure}
\centering
\includegraphics[scale=.17]{gridnumbering.png}
...
\includegraphics[scale=.6]{MapTiles1dvs15DP.pdf}
...
\begin{figure}
%\centering
\includegraphics[scale=.5]{15DayDiffL.pdf}
...
\includegraphics[scale=.6]{Ttest1DayP.pdf}
