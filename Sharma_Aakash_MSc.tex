...
%======================================================
\newcommand{\komTitle}{Differential Map Updates for Highly Automated Driving and Enhanced Driver Assistance Services\xspace}
\newcommand{\komThesisType}{Master-Arbeit\xspace} % Diplomarbeit Studienarbeit Master-Arbeit Bachelor-Arbeit
\newcommand{\komID}{KOM-M-0567\xspace}
\newcommand{\komName}{Aakash Sharma\xspace}
\newcommand{\komSubmissionDate}{31. Dezember 2016\xspace}% use only this date format
\newcommand{\komGutachter}{Gutachter: Prof. Dr.-Ing. Ralf Steinmetz\xspace}
\newcommand{\komBetreuer}{Betreuer: Florian Jomrich\xspace}
